...
OPERATOR_SPECS = {
    ...
    "sign": OperatorSpec("sign", "unary", 1, False, False, "function"),
    ...
    "sec": OperatorSpec("sec", "unary", 1, False, False, "function"),
    "csc": OperatorSpec("csc", "unary", 1, False, False, "function"),
    ...
    "sech": OperatorSpec("sech", "unary", 1, False, False, "function"),
    "csch": OperatorSpec("csch", "unary", 1, False, False, "function"),
