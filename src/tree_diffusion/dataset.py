...
_METADATA_FIELDS = (
    ...
    "trajectory_mode",
    "forward_complete",
    "forward_start_prefix",
    "forward_end_prefix",
    "forward_num_mutations",
    "forward_mutation_kinds",
    "repair_reached_target",
    "repair_step_count",
    "repair_step",
    "repair_step_index",
    "repair_mutation_kind",
    "repair_reason",
    "repair_selected_node_id",
    "repair_selected_node_span",
    "repair_distance_before",
    "repair_distance_after",
    "repair_original_subtree_prefix",
    "repair_replacement_subtree_prefix",
    "repair_before_prefix",
    "repair_after_prefix",
)
